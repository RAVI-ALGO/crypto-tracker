  ...
  const columns = [
          ...
          <span
            ...
            onClick={() => {
              if(url === 'http://localhost:3000/' )
              {
                ...
                navigate(`/${row.id}`,{ state:{page:"Home"} });
              }
              if(url === 'http://localhost:3000/trending' )
              {
                navigate(`/trending/${row.id}`,{ state:{page:"Trending"} });
    ...
    },
    {
      ...
      selector: (row) => (
        <span
          className={
            row.percent_change_1h > 0 ? "text-green-500" : "text-red-500"
          }
        >
          {Number(row.percent_change_1h).toFixed(2)} %
        </span>
      ),
    },
    {
      ...
      selector: (row) => (
        <span
          className={
            row.percent_change_24h > 0 ? "text-green-500" : "text-red-500"
          }
        >
    ...
    },
    {
      ...
      selector: (row) => (
        <span
          className={
            row.percent_change_7d > 0 ? "text-green-500" : "text-red-500"
          }
        >
          {Number(row.percent_change_7d).toFixed(2)} %
        </span>
      ),
    },
  ];
